...
namespace UnifiedUpdatePlatform.Services.Imaging
{
    public class WimImaging : IImaging
    {
        ...
        {
            return (compressionType != WimCompressionType.Lzms && WimgApi.CaptureImage(wimFile, imageName, imageDescription, imageFlag, InputDirectory, tempManager, imageDisplayName, imageDisplayDescription, compressionType, progressCallback, UpdateFrom, PreserveACL)) ||
                WimLib.CaptureImage(wimFile, imageName, imageDescription, imageFlag, InputDirectory, tempManager, imageDisplayName, imageDisplayDescription, compressionType, progressCallback, UpdateFrom, PreserveACL);
        }
